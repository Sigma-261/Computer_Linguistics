...
if __name__ == "__main__":
  ...
  collection_tonality_sentence = db['TonalitySentence']
  ...
  with open('/home/vagrant/Coursework/positive2.csv',encoding='utf-8', newline='') as csvfile:
    data = csvfile.read()
  data = data.replace("\0", "")      
  ...
  with open('/home/vagrant/Coursework/negative2.csv',encoding='utf-8', newline='') as csvfile:
    data = csvfile.read()
  data = data.replace("\0", "")      
  csvfile_repl = io.StringIO(data)
  reader = csv.DictReader(csvfile_repl,delimiter=';')
